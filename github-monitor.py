...
def render_status(info: BuildStatus, row, draw):
    ...
    draw.text([72, y_offset + 12], "{0}".format(info.pr_count), font=small_font, fill='White')
    draw.text([72 + 16, y_offset + 12], "{0}".format(info.branch_count), font=small_font, fill='White')
